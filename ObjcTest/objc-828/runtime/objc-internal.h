...
// 仅在 __LP64__ 环境中支持 Tagged Pointer
#if __LP64__
...
// ARM64使用了一种新的标记指针方案，其中普通标记位于低位，扩展标记位于高位，扩展标记空间的一半保留给未混淆的有效负载。
#   define OBJC_SPLIT_TAGGED_POINTERS 1
#else
#   define OBJC_SPLIT_TAGGED_POINTERS 0
#endif

///OBJC_MSB_TAGGED_POINTERS 表示不同平台下字符串是低位优先排序（LSD）还是高位优先排序（MSD）
...
#define _OBJC_TAG_INDEX_MASK 0x7UL  //0111

#if OBJC_SPLIT_TAGGED_POINTERS
#define _OBJC_TAG_SLOT_COUNT 8   //狭槽数
#define _OBJC_TAG_SLOT_MASK 0x7UL   //掩码
#else
// array slot includes the tag bit itself
#define _OBJC_TAG_SLOT_COUNT 16  //狭槽数
#define _OBJC_TAG_SLOT_MASK 0xfUL  //掩码
#endif

#define _OBJC_TAG_EXT_INDEX_MASK 0xff //扩展标记下标移动掩码
// array slot has no extra bits
#define _OBJC_TAG_EXT_SLOT_COUNT 256 //扩展标记卡槽总数
#define _OBJC_TAG_EXT_SLOT_MASK 0xff //扩展标记卡槽总数
...
#   define _OBJC_TAG_EXT_MASK (_OBJC_TAG_MASK | 0x7UL)  //扩展标记掩码 1000 ... 0111
#   define _OBJC_TAG_NO_OBFUSCATION_MASK ((1UL<<62) | _OBJC_TAG_EXT_MASK)  //无混淆位掩码 1100 ... 0111
...
#   define _OBJC_TAG_EXT_PAYLOAD_LSHIFT 12 //有扩展时负载左边的位数 8 + 3 + 1
#   define _OBJC_TAG_EXT_PAYLOAD_RSHIFT 12 //有扩展时负载右边的位数
#else // LSB
